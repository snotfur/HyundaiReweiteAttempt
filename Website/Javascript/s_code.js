...
/* SiteCatalyst code version: H.17. MDE Integrated
...
/****************************HB WRAPPER FUNCTIONS*********************/

function _hbPageView(a,c){

 if(s_account.indexOf("hmaHgenesisRU") != -1){
  s.pageName=c;  //Hyundai Genesis movie has params backwards!
  s.channel=a;
  }
  else{
  s.pageName=a;
...
s.visitorNamespace="hyundaimotoramerica"
s.dc=122
...
/*
     FILE ARCHIVED ON 01:37:17 Feb 21, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:51:22 Oct 08, 2024.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 80.396 (5)
  load_resource: 152.209 (2)
  PetaboxLoader3.resolve: 70.787 (2)
*/